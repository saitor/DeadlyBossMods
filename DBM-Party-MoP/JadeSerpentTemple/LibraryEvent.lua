...
mod:SetRevision(("$Revision: 7492 $"):sub(12, -3))
mod:SetCreatureID(59051, 59726, 58826)--59051 (Strife), 59726 (Anger), 58826 (Zao Sunseeker)
...
local specWarnUltimatePower	= mod:NewSpecialWarningOther(113309, nil, nil, nil, true)
