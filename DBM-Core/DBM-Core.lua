...
-------------------------------
DBM = {
	Revision = ("$Revision: 6766 $"):sub(12, -3),
	DisplayVersion = "4.10.2b", -- the string that is shown as version
	ReleaseRevision = 6765 -- the revision of the latest stable version that is available
}
