...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 15285 $"):sub(12, -3)),
	DisplayVersion = "7.0.9 alpha", -- the string that is shown as version
	ReleaseRevision = 15283 -- the revision of the latest stable version that is available
}
