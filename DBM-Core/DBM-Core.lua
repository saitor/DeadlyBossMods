...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 14510 $"):sub(12, -3)),
...
do
	...
	function DBM:DemoMode()
		if not testMod then
			...
			testTimer3 = testMod:NewTimer(20, "%s  ", "Interface\\Icons\\Spell_Shadow_ShadesOfDarkness", nil, nil, 3, nil, DBM_CORE_MAGIC_ICON)
			testTimer4 = testMod:NewTimer(20, "%s   ", "Interface\\Icons\\Spell_Nature_WispSplode", nil, nil, 4, nil, DBM_CORE_INTERRUPT_ICON)
			testTimer5 = testMod:NewTimer(20, "%s    ", "Interface\\Icons\\Spell_Fire_SelfDestruct", nil, nil, 2)
			testTimer6 = testMod:NewTimer(20, "%s     ", "Interface\\Icons\\Spell_Nature_WispSplode", nil, nil, 5, nil, DBM_CORE_TANK_ICON)
