...
function mod:SPELL_CAST_START(args)
	...
	elseif args:IsSpellID(92754) then
		...
		if self:GetUnitCreatureId("target") == 41378 or self:GetBossTarget(33186) == UnitName("player") then--Add tank doesn't need this spam, just tank on mal and healers healing that tank.
