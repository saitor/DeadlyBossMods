...
mod:SetRevision(("$Revision: 7137 $"):sub(12, -3))
...
local timerVoidBolt		= mod:NewTargetTimer(22, 108383, nil, mod:IsTank() or mod:IsHealer())--Tooltip says 30 but combat logs clearly show it fading at 20.
