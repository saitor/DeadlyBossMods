...
mod:SetRevision(("$Revision: 15126 $"):sub(12, -3))
...
local timerSavageBladeCD			= mod:NewCDTimer(19.5, 193668, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON)--23 unless delayed by claim aegis or ragnarok
