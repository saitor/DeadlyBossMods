...
mod:SetRevision(("$Revision: 6893 $"):sub(12, -3))
...
local timerSpinners 				= mod:NewNextTimer(15, "ej2770") -- 15secs after Smoldering cast start
local timerSpiderlings				= mod:NewNextTimer(30, "ej2778")
local timerDrone					= mod:NewNextTimer(60, "ej2773")
