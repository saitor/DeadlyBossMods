...
mod:SetRevision(("$Revision: 10169 $"):sub(12, -3))
...
local timerTouchOfYShaarjCD			= mod:NewCDTimer(40, 145071)--^^ CD not yet known except for first
...
function mod:SPELL_CAST_START(args)
	...
	elseif args.spellId == 145037 then
		...
		--countdownWhirlingCorruption:Start()
		soundWhirlingCorrpution:Play()
	elseif args.spellId == 145065 then--Start timer here because it can be blocked if timed really well
